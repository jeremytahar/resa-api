...
function dbConnect() {
    try {
        $db = new PDO('mysql:host=localhost;dbname=tp-api;charset=utf8', 'root', 'root');
...
function addReservation($data) {
    $db = dbConnect();
    $query = $db->prepare('INSERT INTO reservation (last_name, first_name, phone_number, email, date_time) 
                           VALUES (:last_name, :first_name, :phone_number, :email, :date_time)');
